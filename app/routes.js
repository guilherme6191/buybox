...
export default function getRoutes(store) {
  ...
  return (
    <Route path="/" component={App}>
      ...
      <Route path="/adminHome" component={AdminHome} onEnter={ensureIsAdmin}
             onLeave={clearMessages} />
      <Route path="/alerts" component={AlertsContainer} onEnter={ensureIsAdminOrPartner}
             onLeave={clearMessages} />
      <Route path="/addAlert" component={AddAlert} onEnter={ensureAuthenticated}
             onLeave={clearMessages} />
      <Route path="/alert/:id" component={AlertForm} onEnter={ensureAuthenticated}
             onLeave={clearMessages} />
