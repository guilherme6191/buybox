                    ...
                    <div className="col-sm-12">
                        <div className="panel">
                            <div className="panel-body">
                                ...
                                <p>Sim, mas não por especificações técnicas. Ao invés de focarmos em produtos, focamos
                                    nas suas necessidades técnicas. Isso deixa muito mais abrangente a sua
                                    procura pelo com oportunidade de vocês encontrarem o que realmente necessitam.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-sm-12">
                        <div className="panel">
                            <div className="panel-body">
                                <h4>Como funciona?</h4>
                                <p>Você cadastra suas necessidades, exemplo: Celular com 32GB de RAM e câmera de 12MP,
                                ...
                                <p>A gente te notifica por email assim que encontrarmos <b>qualquer</b> produto que
                                    ...
                                    do preço que nos foi informado. Mas lembre-se, pode ser que a gente encontre também
